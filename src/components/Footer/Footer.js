...
const Footer = () => {
    return (
        <div style={{ backgroundColor: 'rgb(60, 82, 68)' }}>
            <div className="d-flex align-items-center justify-content-evenly p-5">
                <div classname="">
                    <div className="text-light">
                        <h1 className="mb-4" style={{ color: 'rgb(242, 197, 252)' }}>Travelly</h1>
                        <h6>23/2 South East Part <br />Dhaka,Bangladesh</h6>
                    </div>
                </div>
                <div className="">
                    <div className="text-light">
                        ...
                        <h6><i class="fas fa-envelope pe-1"></i> travelly23@gmail.com</h6>
                    </div>
