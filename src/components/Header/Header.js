...
const Header = () => {
    ...
    return (
        <div>
            <nav class="navbar navbar-expand-lg navbar-light fixed-top" style={{ backgroundColor: 'rgb(73, 122, 82)' }}>

                <div class="container-fluid">
                    <img className="ms-4 logo" src={logo} alt="" style={{ width: '40px' }} />
                    <span className="title">Travelly</span>
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
                        <span class="navbar-toggler-icon"></span>
                    </button>
                    <div class="collapse navbar-collapse " id="navbarNavDropdown">
                        <ul class="navbar-nav ms-4 mt-1">
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <Link to="/tourist" className="text-light text-decoration-none ps-3">Tourist Club</Link>
                            </li>
                            <li class="nav-item">
                            ...
                            <Link to="/login" className="text-light text-decoration-none ps-3 pe-5">Login</Link>
                            ...
                            <span className="text-light text-decoration-none"> </span>
                            {user?.email && <li class="nav-item">
                                <Link to="/addDestination" className="text-light text-decoration-none ps-3 pe-4">Add Destination</Link>
                            </li>}
